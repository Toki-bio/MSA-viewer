...
Manual 10.2: "Realign block Ctrl+Shift+R ... Isolated single columns are skipped; need at least one span of 2+ columns, otherwise the browser's hard-refresh applies."

Where to look: script.js: function handleKeyDown, case 'r' with shiftKey.
